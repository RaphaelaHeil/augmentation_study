...
class Gated_CNN_BGRU(nn.Module):
    """
    PyTorch implementation based on the model proposed in:
    Arthur Flor de Sousa Neto, Byron Leite Dantas Bezerra, Alejandro Hector Toselli, Estanislau Baptista Lima,
    A robust handwritten recognition system for learning on different data restriction scenarios,
    Pattern Recognition Letters, Volume 159, 2022, Pages 232-238, ISSN 0167-8655,
